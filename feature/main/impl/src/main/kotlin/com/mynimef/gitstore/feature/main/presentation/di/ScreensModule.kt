...
import com.mynimef.gitstore.feature.main.api.AppDetailsDestination
...
import com.mynimef.gitstore.feature.main.presentation.screens.appdetails.AppDetailsScreen
...
internal class ScreensModule {
    ...
    fun provideMainScreen() = object : ComposeDestination {
        ...
        override fun register(builder: NavGraphBuilder) {
            builder.composable(route = route) { backStackEntry ->
                MainScreen()
            }
        }
    }
    ...
    @Provides
    @IntoSet
    fun provideAppDetailsScreen() = object : ComposeDestination {
        override val route = AppDetailsDestination.ROUTE_KEY
